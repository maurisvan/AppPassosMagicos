...
* **Análise Exploratória de Dados (EDA) e ETL:** Limpeza avançada da base de dados histórica, cruzamento de indicadores (IAN, IDA, IEG, IAA, IPS, IPP, IPV) e geração de gráficos gerenciais para storytelling.
